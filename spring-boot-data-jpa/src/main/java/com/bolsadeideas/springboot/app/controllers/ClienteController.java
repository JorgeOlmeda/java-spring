...
public class ClienteController {
	...
	public String ver(@PathVariable(value = "id") Long id, Map<String, Object> model, RedirectAttributes flash, Locale locale) {
		...
		logger.info("Valor del campo foto:" + cliente.getFoto() + "...");
	...
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model,
		...
		if (auth != null) {
			logger.info(
					"Utilizando forma estática SecurityContextHolder.getContext().getAuthentication(): usuario autenticado, username es: "
							.concat(auth.getName()));
		}
